...
from net import baseline_model_kimcnn, baseline_model_cnn, capsule_model_A, capsule_model_B, capsule_model_at, \
    capsule_model_atB, capsule_model_conv, capsule_model_convB,  clstm_model, capsule_model_ALL, capsule_model_ALLB, capsule_model_at_sq, \
...
for epoch in range(args.num_epochs):
    ...
    [precision, recall, F1, support] = \
        precision_recall_fscore_support(y_list, preds_probs, average='binary')
