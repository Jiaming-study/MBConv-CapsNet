...
def load_txt(path_name):
    f=open(path_name, 'r', encoding='ISO-8859-1')
...
#     popular_topics = set(['earn','acq','money-fx','grain','crude','trade','interest','ship','wheat','corn'])
    ...
    #
path_name='data/custrev.all'
single_label, word_to_idx, train, train_label, test, test_label = load_data(path_name,padding=0, sent_len=81, w2i=None)
#print(test_label)
print(train[0])
print(single_label)
